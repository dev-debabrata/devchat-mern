export function createWelcomeEmailTemplate(name, clientURL) {
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #292524; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f4;">
    
    <!-- Header -->
    <div style="background: linear-gradient(to right, #1c1917, #44403c); padding: 30px; text-align: center; border-radius: 12px 12px 0 0;">
    ...
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      ...
      <p style="font-size: 18px; color: #57534e;"><strong>Hello ${name},</strong></p>
      ...
      <div style="background-color: #fafaf9; padding: 25px; border-radius: 10px; margin: 25px 0; border-left: 4px solid #78716c;">
    ...
    <div style="text-align: center; padding: 20px; color: #78716c; font-size: 12px;">
      ...
      <p>
        <a href="#" style="color: #57534e; text-decoration: none; margin: 0 10px;">Privacy Policy</a>
        <a href="#" style="color: #57534e; text-decoration: none; margin: 0 10px;">Terms of Service</a>
        <a href="#" style="color: #57534e; text-decoration: none; margin: 0 10px;">Contact Us</a>
      </p>
    </div>
  </body>
  </html>
...
//       <div style="text-align: center; margin: 30px 0;">
//         <a href=${clientURL} style="background: linear-gradient(to right, #0f172a, #1e40af); color: white; text-decoration: none; padding: 12px 30px; border-radius: 50px; font-weight: 500; display: inline-block;">Open Messenger</a>
//       </div>
